...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-10-2024 a las 19:38:03
...
CREATE TABLE `platforms` (
  ...
  `platform_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `developers` (
  `developer_id` int(11) NOT NULL,
  `developer_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `games_tags`
  MODIFY `game_tags_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `games_platforms`
  MODIFY `game_platforms_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
